  ...
  verify_query($products);
      if(mysqli_num_rows($products)>0){
        while($product = mysqli_fetch_assoc($products)){
          ...
          $product_list .= "<div class=\"product-image\"><img src=\"images/{$product['image_url']}\"style=\"width=100px;height=100px;\"></div>";
          ...
          $product_list .= "<div class=\"show-details \"id=\"\"><a href=\"deleteproduct.php?product_id={$product['id']}\"onclick=\"return confirm ('Are you sure?');\">Delete</a></div>";
         // $product_list .= "<div class=\"show-details\"><a href=\"moredetails.php?descrip={$product['description']}\"><i class=\"fas fa-info-circle\"></i><span> More Details<span></a></div>";
          //$product_list .= "<td>{$product['description']}</td>";
          $product_list .= "<div class=\"show-details \"><a \" href=\"modifyproduct.php?product_id={$product['id']}\">Edit</a></div>";
...
<body>
      ...
      <div class="container-2">
        ...
        <div class="menu">
          ...
          <div class="menuIcons">
            ...
            <span class="micons micons-1"><a href="./adminlogout.php"><i class="fas fa-sign-out-alt"><p class="account">Logout</p></i></a></span>
  ...
  <!-- Start of section 3 -->
    ...
    <h2 class="hedding-shop">Edit Or Delete Products</h2>
