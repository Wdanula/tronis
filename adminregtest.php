...
$errors = array();
    ...
    if(isset($_POST['submit'])){
      ...
      $query = "SELECT * FROM siteadmin WHERE email = '{$email}'LIMIT 1";
      ...
      if(empty($errors)){
        ...
        $query = "INSERT INTO siteadmin(";
        $query .= "first_name, last_name,email ,password, is_deleted, phone_number";
        $query .= ") VALUES (";
        ...
        if($result){
            ...
            header("Location:adminpanel.php?user_added=true");
        }else{
    ...
    <section>
      <div class="container-2">
        ...
        <div class="menu">
          ...
          <span class="menu-items-1">My Account</span>
          <span class="menu-items-1">Login</span>
  ...
  <!-- Start Of Section 3 -->
    <section>
        ...
        <div class="container-user">
            <div class="form">
                <fieldset>
                    <form action="adminregtest.php" method="post" >
