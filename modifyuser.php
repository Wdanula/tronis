    ...
    //   $query .= ")";
     ...
     $query .= "WHERE id='{$user_id}' LIMIT 1";
      ...
      if($result){
          ...
          header("Location:customerlist.php?user_modified=true");
      }else{
    ...
    <section>
      <div class="container-2">
        ...
        <div class="menu">
          ...
          <div class="menuIcons">
             <span class="micons micons-1"><a href="./homeforregisterduser.php"><i class="fas fa-home fa-lg"><p class="home">home</p></i></a></span>
