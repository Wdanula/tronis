...
// }
    ...
    $max_length_fields = array('first_name'=>50,'last_name'=>100,'email'=>100,'password'=>50);
    ...
    <section>
      <div class="container-2">
        ...
        <div class="menu">
          ...
          <span class="menu-items-1"id="userregister">Register</span>
          ...
          <div class="menuIcons">
            ...
            <span class="micons"><a href="./login.php"><i class="fas fa-sign-in-alt"><p class="account">Login</p></i></a></span>
            <!-- <span class="micons"><a href="./login.php"><p class="shop">shop</p><i class="fas fa-question fa-lg"><p class="help">help</p></i></a></span> -->
            ...
            <div class="form">
                <fieldset>
                    <form action="userregistration.php" method="post">
                        <h3 class="registration">User Registration</h3>
                        <?php
                          if(!empty($errors)){
