...
// $address2 = '';
  ...
  $query = "SELECT * FROM products WHERE stock_available=0 AND product_category ='3dprinterandcnc'";    
  ...
  verify_query($products);
      if(mysqli_num_rows($products)>0){
        while($product = mysqli_fetch_assoc($products)){
          ...
          $product_list .= "<div class=\"price\"><span class=\"price-tag\">{$product['price']}</span></div>";
...
<body>
    ...
    <section>
      <div class="container-1">
        <p class="text">Welcome 3D Priner And CNC Section </p>
        <span class="icons">
  ...
  <!-- Start of section 3 -->
    ...
    <h2 class="hedding-shop">3D Printer & CNC Parts</h2>
