...
// $address2 = '';
  ...
  $product_list = '';
    ...
    //   $query = "SELECT * FROM products WHERE (product_name LIKE '%{search}%') AND stock_available=0 ORDER BY product_name";  
    ...
    if(isset($_GET['search'])){
      $search = mysqli_real_escape_string($connection, $_GET['search']);
       $query = "SELECT * FROM products WHERE (product_name LIKE '%{$search}%' OR product_category LIKE '%{$search}%') AND stock_available=0  ORDER BY product_category";  
    }else{
       $query = "SELECT * FROM products WHERE stock_available=0 ORDER BY product_category"; 
    }
  ...
  verify_query($products);
      if(mysqli_num_rows($products)>0){
        while($product = mysqli_fetch_assoc($products)){
          ...
          $product_list .= "<div class=\"show-details\"><a href=\"moredetailsforregistuser.php?product_id={$product['id']}\"><i class=\"fas fa-info-circle\"></i><span> More Details<span></a></div>";
...
<body>
  ...
  <!-- Start Of Section 2 -->
    <section>
      <div class="container-2">
        ...
        <div class="menu">
          <span class="menu-items-1"><a href="./myprofile.php">Home</a></span>
          ...
          <div class="menuIcons">
            <span class="micons micons-1"><a href="./myprofile.php"><i class="fas fa-home fa-lg"><p class="home">home</p></i></a></span>
  ...
  <!-- Start of section 3 -->
    ...
    <div class="container-3">
        <form action="shopforregisterduser.php"method="get">
          <div class="searchBox"><input for=""id="searchBox3" class="inputsearch"value="" placeholder="Search here" type="text"name="search"><button class="allproducts" type="submit">Search</button></div>
        </form>
    </div>
    <h2 class="hedding-shop">Welcome <?php echo $_SESSION['first_name']?></h2>
