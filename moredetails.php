  ...
  <!-- Start Of Section 2 -->
    <section>
      <div class="container-2">
        ...
        <div class="menu">
          <span class="menu-items-1"id="home">More Details</span>
          ...
          <div class="menuIcons">
            ...
            <span class="micons"><i class="fas fa-info-circle"><p class="account">More Details</p></i></span>
    ...
    <div class=" more_details">
     ...
     <div class="right-details">
         <p>
              ...
              <a href="#"style="text-decoration:none;"><p id="place-oder">Place An Oder</p></a>
        </p>
     </div>
