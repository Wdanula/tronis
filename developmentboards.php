...
// $address2 = '';
  ...
  $query = "SELECT * FROM products WHERE stock_available=0 AND product_category ='development_boards'";    
...
<body>
    ...
    <section>
      <div class="container-1">
        <p class="text">Welcome Development Boards Section </p>
        <span class="icons">
  ...
  <!-- Start of section 3 -->
    ...
    <h2 class="hedding-shop">Development Boards</h2>
