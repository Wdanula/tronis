...
<body>
    ...
    <section>
      <div class="container-1">
        <p class="text">Welcome Admin Login</p>
        <span class="icons">
    ...
    <section>
      <div class="container-2">
        ...
        <div class="menu">
          ...
          <!-- <span class="menu-items-1"><a href="./adminregistration.php">Admin Register</a></span> -->
        ...
        <div class="form">
            <fieldset>
                <form action="adminloggin.php" method="post" >
                    <h3 class="loginTitle">Admin Login Section</h3>
                    <?php
